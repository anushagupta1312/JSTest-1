...
// A: It's not a string! 
// B: Yay it's a string! *  (bcz number here is a truthy value and !number is false)
// C: TypeError
// D: undefined
...
// B: 1 and 2
// C: 3 and 4
// D: 3 * (bcz const variable cannot be updated)
...
// C: person.address.street = "101 Main St" * (bcz address is not freezed and its properties can be updated)
...
// Object.seal(person);
// A: person.name = "Evan Bacon" * (bcz properties can be updated)
// B: person.age = 21
...
// A: {name: "Sarah", age: 22}
// B: {name: "Sarah", age: 23}
// C: {name: "Lydia", age: 22} * (bcz no argument is given to changeNameandAge)
// D: { name: "Lydia", age: 23 }
...
//   console.log(x, y);
// }
// A: name Lydia and age 21 * (bcz entries return a key value pair)
...
// B: [1, 2, 3, 5]
// C: [1, 2, 3, 4]
// D: Error * (bcz push return the length of array and to a normal number push method can't be applied)
